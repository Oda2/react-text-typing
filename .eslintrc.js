...
module.exports = {
  ...
  extends: ['plugin:@typescript-eslint/recommended', 'plugin:react/recommended', 'eslint-config-prettier', 'plugin:storybook/recommended'],
  rules: {
  ...
  ignorePatterns: ["**/coverage/**", "**/.storybook/**", "**/storybook-static/**", "**/cypress/**", "**/dist/**", "cypress.config.js"]
};